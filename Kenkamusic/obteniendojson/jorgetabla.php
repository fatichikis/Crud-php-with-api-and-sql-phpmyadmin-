                       ...
                       <div class="panel-body">
							...
							<hr>
                                    <table id="lookup" class="table table-bordered table-hover">  
									   ...
									   <td><center><a href="<?php echo $enlacealbum ?>"  data-toggle="tooltip" title="Ver + Informacion"><img src="https://iconscout.com/ms-icon-310x310.png" width=50" height="50"></a></td> </center>
                                    </center>
									</table>
