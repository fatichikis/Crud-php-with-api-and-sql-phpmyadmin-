	 ...
	 <!-- /agileits -->
            ...
            <div class="container">
             ...
             if(isset($_GET['action']) == 'delete'){
				$rfc_delete = strval($_GET['id_user']);
				$query = mysqli_query($conn, "SELECT * FROM cantantes WHERE id_user=".$_GET['id_user']);
				if(mysqli_num_rows($query) == 0){
					...
					$delete = mysqli_query($conn, "DELETE FROM cantantes WHERE id_user=".$_GET['id_user']);
					if($delete)
					{
                     echo '
			...
			?>   
                    ...
                    <div class="panel panel-default">
                        ...
                        <h3 class="panel-title"><i class="icon-user"></i> Canciones del momento...</h3> 
						 
                        </div>
						
                        <div class="panel-body">
							<div class="pull-right">
								<a href="registro.php" class="btn btn-sm btn-primary">Anexar Nueva Cancion</a>
							</div><br>
							<hr>
